...
Para anunciar a vaga clique <a href="https://github.com/reactrio/vagas/issues/new?template=adicionar-nova-vaga.md&title=[NOME+DA+EMPRESA]+Desenvolvedor+React">aqui</a>.

Exemplo: `[NOME DA EMPRESA] Desenvolvedor React ou React Native`
